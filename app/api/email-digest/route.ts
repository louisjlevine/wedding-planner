...
import type { Task, TimelineItem, Vendor, WeddingAnswers, BudgetCategory, EmailDigestPrefs } from "@/lib/types";
...
function isValidBody(body: unknown): body is DigestRequestBody {
...
function buildDigest(data: DigestRequestBody) {
